...
| ----------- | ----------------------------------------- |
| User Tags   | Created manually by the user.             |
| AI Tags     | Generated automatically by AI components. |
| System Tags | Generated internally by the application.  |
| Plugin Tags | Generated by installed plugins.           |
