...
| v1.0 Integrated Local Understanding | Release-candidate UX/AI hardening, final visual polish, README, and Windows portable distribution complete; manual UI/OCR/Ollama/platform verification pending | Exact restore, Debug/Release builds, 543 automated tests in both configurations, self-contained win-x64 publish, package inspection, and published-executable startup passed; zero final build warnings/errors. | Official native branding, persisted resizable Files/details layout, public README, self-contained portable ZIP, six-destination shell, Meaning Search, hardened Ollama state, OCR, provenance tags, deterministic restructuring, and history. |
