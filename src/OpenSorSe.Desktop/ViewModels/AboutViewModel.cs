...
public sealed class AboutViewModel : ViewModelBase
{
    ...
    /// </summary>
    public Uri RepositoryUri { get; } = new("https://github.com/OpenSorSe/OpenSorSe", UriKind.Absolute);

    /// <summary>
    /// Gets the public project documentation URI.
    /// </summary>
    public Uri DocumentationUri { get; } = new("https://github.com/OpenSorSe/OpenSorSe/tree/main/docs", UriKind.Absolute);
